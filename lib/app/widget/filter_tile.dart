              ...
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Continents', style: themeData.textTheme.bodyText1),
                      IconButton(
                          onPressed: () {
                            setState(() {
                  ...
                  continentsOpened
                      ? Column(
                          children: List.generate(
                            7,
                            (index) => ContinentTile(title: continents[index]),
                          ),
                        )
                      : const SizedBox(),
                ],
              ...
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Time Zones', style: themeData.textTheme.bodyText1),
                      IconButton(
                          onPressed: () {
                            setState(() {
                  ...
                  timeZonesOpened
                      ? Column(
                          children: List.generate(
                            8,
                            (index) => ContinentTile(title: timeZones[index]),
                          ),
                        )
                      : const SizedBox(),
                ],
